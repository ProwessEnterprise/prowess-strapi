...
export interface ApiLifeAtProwessLifeAtProwess
  extends Struct.CollectionTypeSchema {
  collectionName: 'life_at_prowesses';
  info: {
    displayName: 'Life at Prowess';
    pluralName: 'life-at-prowesses';
    singularName: 'life-at-prowess';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    awsImageUrl: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::life-at-prowess.life-at-prowess'
    > &
      Schema.Attribute.Private;
    occasion: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::life-at-prowess.life-at-prowess': ApiLifeAtProwessLifeAtProwess;
